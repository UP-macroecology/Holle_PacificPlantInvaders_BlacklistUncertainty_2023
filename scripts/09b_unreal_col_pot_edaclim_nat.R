...
# Load needed objects
load("output_data/model_predictions/native/edaclim/islandgroups_results_edaclim_native.RData") # Data frame with prediction results of all species based on 25 island groups
