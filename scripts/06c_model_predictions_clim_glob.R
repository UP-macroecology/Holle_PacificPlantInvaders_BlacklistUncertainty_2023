  ...
  try({
    ...
    for (t in threshold_methods) { # Start the loop over the different thresholding methods
      try({
        ...
        file_exists <- file.exists(paste0("output_data/model_predictions/global/clim/",t,"/islandgroups_results_clim_global_spec_",sp,".RData"))
        ...
        if (file_exists == FALSE) { # just continue with model predictions if output 
          ...
          save(islandgroups_results_clim_global_spec, file = paste0("output_data/model_predictions/global/clim/",t,"/islandgroups_results_clim_global_spec_",sp,".RData"))
...
for (t in threshold_methods) { # Start the loop over the three thresholding methods
  try({
    ...
    for (sp in study_species) {
      try({
        ...
        if (file_exists == TRUE) { # just continue with model predictions if output 
          ...
          load(paste0("output_data/model_predictions/global/clim/",t,"/islandgroups_results_clim_global_spec_",sp,".RData"))
    ...
    save(islandgroups_results_clim_global, file = paste0("output_data/model_predictions/global/clim/",t,"/islandgroups_results_clim_global.RData"))
  ...
  try({
    ...
    for (t in threshold_methods) { # Start the loop over the three thresholding methods
      try({
        ...
        file_exists <- file.exists(paste0("output_data/model_predictions/global/clim_comp/",t,"/islandgroups_results_clim_global_spec_comp_",sp,".RData"))
        ...
        if (file_exists == FALSE) { # just continue with new area calculations if output 
          ...
          # Save the results data frame per species
          save(islandgroups_results_clim_global_spec_comp, file = paste0("output_data/model_predictions/global/clim_comp/",t,"/islandgroups_results_clim_global_spec_comp_",sp,".RData"))
...
for (t in threshold_methods) { # Start the loop over the three thresholding methods
  try({
    ...
    for (sp in study_species) {
      try({
        ...
        if (file_exists == TRUE) { # just continue with model predictions if output 
          ...
          # Load the file with predictions results
          load(paste0("output_data/model_predictions/global/clim_comp/",t,"/islandgroups_results_clim_global_spec_comp_",sp,".RData"))
    ...
    # Save the data frame containing all prediction results
    save(islandgroups_results_clim_global_comp, file = paste0("output_data/model_predictions/global/clim_comp/",t,"/islandgroups_results_clim_global_comp.RData"))
