  ...
  try({
    ...
    for (t in threshold_methods) { # Start the loop over the different thresholding methods
      try({
        ...
        file_exists <- file.exists(paste0("output_data/model_predictions/global/edaclim/",t,"/islandgroups_results_edaclim_global_spec_",sp,".RData"))
        ...
        if (file_exists == FALSE) { # just continue with model predictions if output 
          ...
          load(paste0("output_data/models/global/edaclim/models_edaclim_global_",sp,".RData")) # the four different models
          load(paste0("output_data/validation/global/edaclim/validation_edaclim_global_",sp,".RData")) # validation outcomes
          ...
          save(islandgroups_results_edaclim_global_spec, file = paste0("output_data/model_predictions/global/edaclim/",t,"/islandgroups_results_edaclim_global_spec_",sp,".RData"))
...
for (t in threshold_methods) { # Start the loop over the three thresholding methods
  try({
    ...
    for (sp in study_species) {
      try({
        ...
        if (file_exists == TRUE) { # just continue with model predictions if output 
          ...
          load(paste0("output_data/model_predictions/global/edaclim/",t,"/islandgroups_results_edaclim_global_spec_",sp,".RData"))
    ...
    save(islandgroups_results_edaclim_global, file = paste0("output_data/model_predictions/global/edaclim/",t,"/islandgroups_results_edaclim_global.RData"))
