...
colnames(results_mean_rank_islandgroups_clim_native) <- c("mean_rank", "algorithm", "predictor_type", "niche", "species")
...
colnames(results_mean_rank_islandgroups_clim_native_comp) <- c("mean_rank", "algorithm", "predictor_type", "niche", "species")
