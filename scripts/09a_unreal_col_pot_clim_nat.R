...
# (a) based on 49 island groups covered by climatic data -----------------------
  ...
  # Load needed objects
  load(paste0("output_data/model_predictions_rev/native/clim/",t,"/islandgroups_results_clim_native.RData")) # Data frame with prediction results of all species based on 49 island groups
  ...
  save(unreal_col_pot_clim_native, file = paste0("output_data/unrealized_col_pot_rev/native/clim/",t,"/unreal_col_pot_clim_native.RData"))
...
# (b) based on 25 island groups covered by climatic and edaphic data -----------
  ...
  # Load needed objects
  load(paste0("output_data/model_predictions_rev/native/clim_comp/",t,"/islandgroups_results_clim_native_comp.RData")) # Data frame with prediction results of all species based on 25 island groups
  load("input_data/observed_occ_pacific_islands.RData") # observed occurrences
  load("input_data/occ_numbers_thinned_env_filtered.RData") # Contains names of study species
  ...
  # Save the results data frame containing the unrealized colonization potential 
  # of all study species
  save(unreal_col_pot_clim_native_comp, file = paste0("output_data/unrealized_col_pot_rev/native/clim_comp/",t,"/unreal_col_pot_clim_native_comp.RData"))
